if (!DNNEO.neo.Resource.ajax) {
    DNNEO.neo.Resource.ajax = {};
}
$.extend(DNNEO.neo.Resource.ajax, {
...
if (!DNNEO.neo.Resource.dateTime) {
    DNNEO.neo.Resource.dateTime = {};
}
$.extend(DNNEO.neo.Resource.dateTime, {
    /* 短い月の名前 */
...
$.extend(desknets.Resource.ntwi, {
  ...
  'urlShortenExist': '登録済みの短縮URLを表示しました',
...
//-----------------------------------------------------------
    ...
    , 'sch_msetaccentry_noperm': 'M:管理できる組織に所属するユーザーのみアクセス権の設定が可能です。\n設定できないユーザーは対象から除外しました。'
...
if (typeof $.datepicker == 'object') {
    $.datepicker.setDefaults({
        ...
        monthNames: DNNEO.neo.Resource.dateTime['longMonthes'],
        monthNamesShort: DNNEO.neo.Resource.dateTime['longMonthes'],
        dayNames: DNNEO.neo.Resource.dateTime['longWeeks'],
        dayNamesShort: DNNEO.neo.Resource.dateTime['shortWeeks'],
        dayNamesMin: DNNEO.neo.Resource.dateTime['shortWeeks'],
