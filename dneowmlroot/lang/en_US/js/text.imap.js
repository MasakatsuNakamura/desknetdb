...
$.extend(neo.denbun.textMap, {
    ...
    // メール一覧画面
    'アカウントがありません。アカウントを設定しますか？': 'You have no accounts. Do you want to setup email account?',
    ...
    // ディレクトリ
    '検索中です。しばらくお待ちください...': 'Search is in progress. Please wait for awhile.',
    '検索中止': 'Stop Searching',
    '検索条件に該当するデータはありませんでした。': 'There are no data that meet your search criteria.',
    '検索項目を選択してください。': 'Select items(s)',
    ...
    'ウェブメールIMAPを終了します。\n※[ウェブメールIMAP]から起動したブラウザも全て終了します。': 'The WebMail IMAP will be closed. \n* All the browsers started from "WebMail IMAP" will be closed.',
    ...
    '未送信のメールがあります。\n※ウェブメールIMAPを終了すると未送信メールは「下書き」に保存されます。': 'You have at least one unsent message. \n* It will be saved in "Drafts" when you quit WebMail IMAP.',
    ...
    'ウェブメールIMAP': 'WebMail IMAP',
    'メールの送信に失敗しました。': 'Failed to send messages.',
